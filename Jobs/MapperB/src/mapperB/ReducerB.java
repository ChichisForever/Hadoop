...
//Funcion reduce para el job B
//Cuenta la cantidad de errores para cada producto y version en un mes determinado

public class ReducerB extends Reducer<Text, IntWritable, Text, IntWritable> {
